...
В этом кратком руководстве описан процесс установке и настройки мониторинга на основе Prometheus, Node exporter и Alertmanager с последующей отправкой алертов в телеграмм.
