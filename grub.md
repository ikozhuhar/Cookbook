...
```ruby
	...
	# GRUB_HIDDEN_TIMEOUT_QUIET=true запрещает отображение таймера обратного отсчета. Если установить на компьютер
	# еще одну операционную систему в режиме мультизагрузки, то меню GRUB должно стать видимым автоматически.
