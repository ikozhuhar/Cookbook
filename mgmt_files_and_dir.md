...
Каждый файл уникально идентифицируется индексным узлом (`inode`), а индексный узел — это то, на что ссылается жесткая ссылка, то есть жесткая ссылка ссылается не на имя файла, а на индексный узел. В следующем примере индексный узел имеет номер `9569138`, и тот же номер используется в трех жестких ссылках:
