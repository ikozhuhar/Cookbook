### ✅ Монтирование удаленной папки на CP-APP-1 (192.168.2.162)
<hr>
...
_**Краткий ответ**: Строка из файла `/etc/fstab` для автоматического подключения (монтирования) удаленной сетевой папки `//192.168.2.32/DWH_Portal_Statistic` к локальной файловой системе при загрузке компьютера. Папка будет доступна в директории `/mnt/DWH_Portal_Statistic`._
